                            ...
                            {lectures.map((lecture, idx) => {
                                return (
                                    <li className="space-y-2" key={lecture._id}>
                                        ...
                                        {role === "ADMIN" && (
                                            <button onClick={() => onLectureDelete(state?._id, lecture?._id)} className="bg-red-600 hover:bg-red-700 text-white px-2 py-0.5 rounded text-xs font-medium shadow-sm hover:shadow-md transition-all duration-200">
                                                Delete lecture
                                            </button>
                                        )}
                                    </li>
