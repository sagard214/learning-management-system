...
import { createNewCourse } from "../../redux/slices/coureSlice";
    ...
    return(
        <HomeLayout>
            ...
            <form
                    ...
                    className="flex flex-col justify-center gap-5 rounded-lg p-4 text-white h-[550px] w-[700px] my-10 shadow-[0_0_10px_black] relative"
                >   
